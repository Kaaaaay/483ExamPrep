...
namespace _07___Mortgage_App
{
    class Program
    {
        ...
        {
            ReadPositveDecimal("Please enter the principal amount:      ");
            ReadPositveDecimal("Please enter the interest rate:         ");
            ReadPositveDecimal("Please enter the monthly payment:       ");
